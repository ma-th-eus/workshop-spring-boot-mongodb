...
import com.matheuscosta.workshopmongo.dto.AuthorDTO;
import com.matheuscosta.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		CommentDTO c2 = new CommentDTO("Cuidado, sua desgraça!", sdf.parse("22/03/2018"), new AuthorDTO(bob));
